...
public class VideoUserTransactionEntryLocalServiceUtil {
	...
	*/
	public static java.util.List<vn.com.fis.portal.model.VideoUserTransactionEntry> findByTransactionCode(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByTransactionCode(transactionCode, start, end);
	}
	...
	*/
	public static java.util.List<vn.com.fis.portal.model.VideoUserTransactionEntry> findByDate(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByDate(date_);
	}
	...
	*/
	public static java.util.List<vn.com.fis.portal.model.VideoUserTransactionEntry> findByDate(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByDate(date_, start, end);
	}
	...
	*/
	public static int countByDate(java.util.Date date_)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().countByDate(date_);
	}
	...
	*/
	public static java.util.List<vn.com.fis.portal.model.VideoUserTransactionEntry> findByreceiverId(
		long receiverId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByreceiverId(receiverId);
	}
	...
	*/
	public static java.util.List<vn.com.fis.portal.model.VideoUserTransactionEntry> findByreceiverId(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByreceiverId(receiverId, start, end);
	}
