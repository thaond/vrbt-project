...
/**
 * The base implementation of the category entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.CategoryEntryLocalServiceImpl}.
 * </p>
 *
 * @author loind
...
public abstract class CategoryEntryLocalServiceBaseImpl
	implements CategoryEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.CategoryEntryLocalServiceUtil} to access the category entry local service.
	 */
	...
	public CategoryEntry addCategoryEntry(CategoryEntry categoryEntry)
		...
		categoryEntry = categoryEntryPersistence.update(categoryEntry, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(categoryEntry);
			}
	...
	public void deleteCategoryEntry(long categoryId)
		...
		CategoryEntry categoryEntry = categoryEntryPersistence.remove(categoryId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(categoryEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteCategoryEntry(CategoryEntry categoryEntry)
		throws SystemException {
		categoryEntryPersistence.remove(categoryEntry);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCategoryEntriesCount() throws SystemException {
	...
	public CategoryEntry updateCategoryEntry(CategoryEntry categoryEntry)
		throws SystemException {
		return updateCategoryEntry(categoryEntry, true);
	}
	...
	public CategoryEntry updateCategoryEntry(CategoryEntry categoryEntry,
		...
		categoryEntry = categoryEntryPersistence.update(categoryEntry, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.CategoryEntry",
			categoryEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.CategoryEntry");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(CategoryEntryLocalServiceBaseImpl.class);
