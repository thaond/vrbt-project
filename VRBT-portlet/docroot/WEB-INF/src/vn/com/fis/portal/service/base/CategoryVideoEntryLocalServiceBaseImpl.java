...
/**
 * The base implementation of the category video entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.CategoryVideoEntryLocalServiceImpl}.
 * </p>
 *
 * @author loind
 ...
 * @generated
 */
public abstract class CategoryVideoEntryLocalServiceBaseImpl
	implements CategoryVideoEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.CategoryVideoEntryLocalServiceUtil} to access the category video entry local service.
	 */
	 ...
	 */
	public CategoryVideoEntry addCategoryVideoEntry(
		CategoryVideoEntry categoryVideoEntry) throws SystemException {
		categoryVideoEntry.setNew(true);

		categoryVideoEntry = categoryVideoEntryPersistence.update(categoryVideoEntry,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(categoryVideoEntry);
			}
	 ...
	 */
	public CategoryVideoEntry createCategoryVideoEntry(long categoryViceoId) {
		return categoryVideoEntryPersistence.create(categoryViceoId);
	}
	...
	public void deleteCategoryVideoEntry(long categoryViceoId)
		...
		CategoryVideoEntry categoryVideoEntry = categoryVideoEntryPersistence.remove(categoryViceoId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(categoryVideoEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteCategoryVideoEntry(CategoryVideoEntry categoryVideoEntry)
		throws SystemException {
		categoryVideoEntryPersistence.remove(categoryVideoEntry);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return categoryVideoEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return categoryVideoEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public CategoryVideoEntry fetchCategoryVideoEntry(long categoryViceoId)
		throws SystemException {
		return categoryVideoEntryPersistence.fetchByPrimaryKey(categoryViceoId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CategoryVideoEntry getCategoryVideoEntry(long categoryViceoId)
		throws PortalException, SystemException {
		return categoryVideoEntryPersistence.findByPrimaryKey(categoryViceoId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return categoryVideoEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<CategoryVideoEntry> getCategoryVideoEntries(int start, int end)
		throws SystemException {
		return categoryVideoEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCategoryVideoEntriesCount() throws SystemException {
		return categoryVideoEntryPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CategoryVideoEntry updateCategoryVideoEntry(
		CategoryVideoEntry categoryVideoEntry) throws SystemException {
		return updateCategoryVideoEntry(categoryVideoEntry, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.CategoryVideoEntry",
			categoryVideoEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.CategoryVideoEntry");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(CategoryVideoEntryLocalServiceBaseImpl.class);
