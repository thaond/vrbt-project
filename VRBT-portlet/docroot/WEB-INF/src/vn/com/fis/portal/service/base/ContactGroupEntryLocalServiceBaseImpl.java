...
/**
 * The base implementation of the contact group entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.ContactGroupEntryLocalServiceImpl}.
 * </p>
 *
 * @author loind
 ...
 * @generated
 */
public abstract class ContactGroupEntryLocalServiceBaseImpl
	implements ContactGroupEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.ContactGroupEntryLocalServiceUtil} to access the contact group entry local service.
	 */
	 ...
	 */
	public ContactGroupEntry addContactGroupEntry(
		ContactGroupEntry contactGroupEntry) throws SystemException {
		contactGroupEntry.setNew(true);

		contactGroupEntry = contactGroupEntryPersistence.update(contactGroupEntry,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(contactGroupEntry);
			}
	 ...
	 */
	public ContactGroupEntry createContactGroupEntry(long contactGroupId) {
		return contactGroupEntryPersistence.create(contactGroupId);
	}
	...
	public void deleteContactGroupEntry(long contactGroupId)
		...
		ContactGroupEntry contactGroupEntry = contactGroupEntryPersistence.remove(contactGroupId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(contactGroupEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteContactGroupEntry(ContactGroupEntry contactGroupEntry)
		throws SystemException {
		contactGroupEntryPersistence.remove(contactGroupEntry);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return contactGroupEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return contactGroupEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ContactGroupEntry fetchContactGroupEntry(long contactGroupId)
		throws SystemException {
		return contactGroupEntryPersistence.fetchByPrimaryKey(contactGroupId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ContactGroupEntry getContactGroupEntry(long contactGroupId)
		throws PortalException, SystemException {
		return contactGroupEntryPersistence.findByPrimaryKey(contactGroupId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return contactGroupEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ContactGroupEntry> getContactGroupEntries(int start, int end)
		throws SystemException {
		return contactGroupEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getContactGroupEntriesCount() throws SystemException {
		return contactGroupEntryPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ContactGroupEntry updateContactGroupEntry(
		ContactGroupEntry contactGroupEntry) throws SystemException {
		return updateContactGroupEntry(contactGroupEntry, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.ContactGroupEntry",
			contactGroupEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.ContactGroupEntry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = contactGroupEntryPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(ContactGroupEntryLocalServiceBaseImpl.class);
