...
/**
 * The base implementation of the notification entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.NotificationEntryLocalServiceImpl}.
 * </p>
 *
 * @author loind
...
public abstract class NotificationEntryLocalServiceBaseImpl
	implements NotificationEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.NotificationEntryLocalServiceUtil} to access the notification entry local service.
	 */
	...
	public NotificationEntry addNotificationEntry(
		NotificationEntry notificationEntry) throws SystemException {
		notificationEntry.setNew(true);

		notificationEntry = notificationEntryPersistence.update(notificationEntry,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(notificationEntry);
			}
	 ...
	 */
	public NotificationEntry createNotificationEntry(long notificationId) {
		return notificationEntryPersistence.create(notificationId);
	}
	...
	public void deleteNotificationEntry(long notificationId)
		...
		NotificationEntry notificationEntry = notificationEntryPersistence.remove(notificationId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(notificationEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteNotificationEntry(NotificationEntry notificationEntry)
		...
		notificationEntryPersistence.remove(notificationEntry);
	...
	public NotificationEntry fetchNotificationEntry(long notificationId)
		throws SystemException {
		return notificationEntryPersistence.fetchByPrimaryKey(notificationId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public NotificationEntry getNotificationEntry(long notificationId)
		throws PortalException, SystemException {
		return notificationEntryPersistence.findByPrimaryKey(notificationId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getNotificationEntriesCount() throws SystemException {
	...
	public NotificationEntry updateNotificationEntry(
		NotificationEntry notificationEntry) throws SystemException {
		return updateNotificationEntry(notificationEntry, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.NotificationEntry",
			notificationEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.NotificationEntry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = notificationEntryPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(NotificationEntryLocalServiceBaseImpl.class);
