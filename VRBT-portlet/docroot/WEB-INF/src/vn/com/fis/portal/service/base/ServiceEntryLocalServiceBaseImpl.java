...
/**
 * The base implementation of the service entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.ServiceEntryLocalServiceImpl}.
 * </p>
 *
 * @author loind
 ...
 * @generated
 */
public abstract class ServiceEntryLocalServiceBaseImpl
	implements ServiceEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.ServiceEntryLocalServiceUtil} to access the service entry local service.
	 */
	 ...
	 */
	public ServiceEntry addServiceEntry(ServiceEntry serviceEntry)
		throws SystemException {
		serviceEntry.setNew(true);

		serviceEntry = serviceEntryPersistence.update(serviceEntry, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(serviceEntry);
			}
	 ...
	 */
	public ServiceEntry createServiceEntry(long serviceId) {
		return serviceEntryPersistence.create(serviceId);
	}
	...
	public void deleteServiceEntry(long serviceId)
		...
		ServiceEntry serviceEntry = serviceEntryPersistence.remove(serviceId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(serviceEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteServiceEntry(ServiceEntry serviceEntry)
		throws SystemException {
		serviceEntryPersistence.remove(serviceEntry);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return serviceEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return serviceEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ServiceEntry fetchServiceEntry(long serviceId)
		throws SystemException {
		return serviceEntryPersistence.fetchByPrimaryKey(serviceId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ServiceEntry getServiceEntry(long serviceId)
		throws PortalException, SystemException {
		return serviceEntryPersistence.findByPrimaryKey(serviceId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return serviceEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ServiceEntry> getServiceEntries(int start, int end)
		throws SystemException {
		return serviceEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getServiceEntriesCount() throws SystemException {
		return serviceEntryPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ServiceEntry updateServiceEntry(ServiceEntry serviceEntry)
		throws SystemException {
		return updateServiceEntry(serviceEntry, true);
	}
	...
	public ServiceEntry updateServiceEntry(ServiceEntry serviceEntry,
		...
		serviceEntry = serviceEntryPersistence.update(serviceEntry, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.ServiceEntry",
			serviceEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.ServiceEntry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = serviceEntryPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(ServiceEntryLocalServiceBaseImpl.class);
