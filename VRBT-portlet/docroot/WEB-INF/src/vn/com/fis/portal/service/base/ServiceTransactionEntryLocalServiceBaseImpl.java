...
/**
 * The base implementation of the service transaction entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.ServiceTransactionEntryLocalServiceImpl}.
 * </p>
 *
 * @author loind
 ...
 * @generated
 */
public abstract class ServiceTransactionEntryLocalServiceBaseImpl
	implements ServiceTransactionEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.ServiceTransactionEntryLocalServiceUtil} to access the service transaction entry local service.
	 */
	 ...
	 */
	public ServiceTransactionEntry addServiceTransactionEntry(
		ServiceTransactionEntry serviceTransactionEntry)
		throws SystemException {
		serviceTransactionEntry.setNew(true);

		serviceTransactionEntry = serviceTransactionEntryPersistence.update(serviceTransactionEntry,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(serviceTransactionEntry);
			}
	 ...
	 */
	public ServiceTransactionEntry createServiceTransactionEntry(
		long transactionId) {
		return serviceTransactionEntryPersistence.create(transactionId);
	}
	...
	public void deleteServiceTransactionEntry(long transactionId)
		...
		ServiceTransactionEntry serviceTransactionEntry = serviceTransactionEntryPersistence.remove(transactionId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(serviceTransactionEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteServiceTransactionEntry(
		ServiceTransactionEntry serviceTransactionEntry)
		throws SystemException {
		serviceTransactionEntryPersistence.remove(serviceTransactionEntry);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return serviceTransactionEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return serviceTransactionEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ServiceTransactionEntry fetchServiceTransactionEntry(
		long transactionId) throws SystemException {
		return serviceTransactionEntryPersistence.fetchByPrimaryKey(transactionId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ServiceTransactionEntry getServiceTransactionEntry(
		long transactionId) throws PortalException, SystemException {
		return serviceTransactionEntryPersistence.findByPrimaryKey(transactionId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return serviceTransactionEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ServiceTransactionEntry> getServiceTransactionEntries(
		int start, int end) throws SystemException {
		return serviceTransactionEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getServiceTransactionEntriesCount() throws SystemException {
		return serviceTransactionEntryPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ServiceTransactionEntry updateServiceTransactionEntry(
		ServiceTransactionEntry serviceTransactionEntry)
		throws SystemException {
		return updateServiceTransactionEntry(serviceTransactionEntry, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.ServiceTransactionEntry",
			serviceTransactionEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.ServiceTransactionEntry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = serviceTransactionEntryPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(ServiceTransactionEntryLocalServiceBaseImpl.class);
