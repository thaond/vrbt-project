...
/**
 * The base implementation of the user entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.UserEntryLocalServiceImpl}.
 * </p>
 *
 * @author loind
...
public abstract class UserEntryLocalServiceBaseImpl
	implements UserEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.UserEntryLocalServiceUtil} to access the user entry local service.
	 */
	...
	public UserEntry addUserEntry(UserEntry userEntry)
		...
		userEntry = userEntryPersistence.update(userEntry, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(userEntry);
			}
	 ...
	 */
	public UserEntry createUserEntry(long userId) {
		return userEntryPersistence.create(userId);
	}
	...
	public void deleteUserEntry(long userId)
		...
		UserEntry userEntry = userEntryPersistence.remove(userId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(userEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteUserEntry(UserEntry userEntry) throws SystemException {
		userEntryPersistence.remove(userEntry);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return userEntryPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public UserEntry fetchUserEntry(long userId) throws SystemException {
		return userEntryPersistence.fetchByPrimaryKey(userId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public UserEntry getUserEntry(long userId)
		throws PortalException, SystemException {
		return userEntryPersistence.findByPrimaryKey(userId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getUserEntriesCount() throws SystemException {
	...
	public UserEntry updateUserEntry(UserEntry userEntry)
		throws SystemException {
		return updateUserEntry(userEntry, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public UserEntry updateUserEntry(UserEntry userEntry, boolean merge)
		throws SystemException {
		userEntry.setNew(false);

		userEntry = userEntryPersistence.update(userEntry, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.UserEntry",
			userEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.UserEntry");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(UserEntryLocalServiceBaseImpl.class);
