...
/**
 * The base implementation of the user service entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.UserServiceEntryLocalServiceImpl}.
 * </p>
 *
 * @author loind
 ...
 * @generated
 */
public abstract class UserServiceEntryLocalServiceBaseImpl
	implements UserServiceEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.UserServiceEntryLocalServiceUtil} to access the user service entry local service.
	 */
	 ...
	 */
	public UserServiceEntry addUserServiceEntry(
		UserServiceEntry userServiceEntry) throws SystemException {
		userServiceEntry.setNew(true);

		userServiceEntry = userServiceEntryPersistence.update(userServiceEntry,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(userServiceEntry);
			}
	 ...
	 */
	public UserServiceEntry createUserServiceEntry(long userServiceId) {
		return userServiceEntryPersistence.create(userServiceId);
	}
	...
	public void deleteUserServiceEntry(long userServiceId)
		...
		UserServiceEntry userServiceEntry = userServiceEntryPersistence.remove(userServiceId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(userServiceEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteUserServiceEntry(UserServiceEntry userServiceEntry)
		throws SystemException {
		userServiceEntryPersistence.remove(userServiceEntry);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return userServiceEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return userServiceEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public UserServiceEntry fetchUserServiceEntry(long userServiceId)
		throws SystemException {
		return userServiceEntryPersistence.fetchByPrimaryKey(userServiceId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public UserServiceEntry getUserServiceEntry(long userServiceId)
		throws PortalException, SystemException {
		return userServiceEntryPersistence.findByPrimaryKey(userServiceId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return userServiceEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<UserServiceEntry> getUserServiceEntries(int start, int end)
		throws SystemException {
		return userServiceEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getUserServiceEntriesCount() throws SystemException {
		return userServiceEntryPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public UserServiceEntry updateUserServiceEntry(
		UserServiceEntry userServiceEntry) throws SystemException {
		return updateUserServiceEntry(userServiceEntry, true);
	}
	 ...
	 */
	public UserServiceEntry updateUserServiceEntry(
		UserServiceEntry userServiceEntry, boolean merge)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.UserServiceEntry",
			userServiceEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.UserServiceEntry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = userServiceEntryPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(UserServiceEntryLocalServiceBaseImpl.class);
