 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.VideoEntryLocalServiceImpl}.
 * </p>
 *
 * @author loind
...
public abstract class VideoEntryLocalServiceBaseImpl
	implements VideoEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.VideoEntryLocalServiceUtil} to access the video entry local service.
	 */
	...
	public VideoEntry addVideoEntry(VideoEntry videoEntry)
		...
		videoEntry = videoEntryPersistence.update(videoEntry, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(videoEntry);
			}
	 ...
	 */
	public VideoEntry createVideoEntry(long videoId) {
		return videoEntryPersistence.create(videoId);
	}
	...
	public void deleteVideoEntry(long videoId)
		...
		VideoEntry videoEntry = videoEntryPersistence.remove(videoId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(videoEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVideoEntry(VideoEntry videoEntry)
		throws SystemException {
		videoEntryPersistence.remove(videoEntry);
	...
	public VideoEntry fetchVideoEntry(long videoId) throws SystemException {
		return videoEntryPersistence.fetchByPrimaryKey(videoId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VideoEntry getVideoEntry(long videoId)
		throws PortalException, SystemException {
		return videoEntryPersistence.findByPrimaryKey(videoId);
	}
	...
	public VideoEntry updateVideoEntry(VideoEntry videoEntry, boolean merge)
		...
		videoEntry = videoEntryPersistence.update(videoEntry, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.VideoEntry",
			videoEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.VideoEntry");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(VideoEntryLocalServiceBaseImpl.class);
