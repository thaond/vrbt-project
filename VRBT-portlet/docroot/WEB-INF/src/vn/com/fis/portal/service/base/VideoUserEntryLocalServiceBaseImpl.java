...
/**
 * The base implementation of the video user entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.VideoUserEntryLocalServiceImpl}.
 * </p>
 *
 * @author loind
 ...
 * @generated
 */
public abstract class VideoUserEntryLocalServiceBaseImpl
	implements VideoUserEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.VideoUserEntryLocalServiceUtil} to access the video user entry local service.
	 */
	 ...
	 */
	public VideoUserEntry addVideoUserEntry(VideoUserEntry videoUserEntry)
		throws SystemException {
		videoUserEntry.setNew(true);

		videoUserEntry = videoUserEntryPersistence.update(videoUserEntry, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(videoUserEntry);
			}
	 ...
	 */
	public VideoUserEntry createVideoUserEntry(long videoUserId) {
		return videoUserEntryPersistence.create(videoUserId);
	}
	...
	public void deleteVideoUserEntry(long videoUserId)
		...
		VideoUserEntry videoUserEntry = videoUserEntryPersistence.remove(videoUserId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(videoUserEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVideoUserEntry(VideoUserEntry videoUserEntry)
		throws SystemException {
		videoUserEntryPersistence.remove(videoUserEntry);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return videoUserEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return videoUserEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public VideoUserEntry fetchVideoUserEntry(long videoUserId)
		throws SystemException {
		return videoUserEntryPersistence.fetchByPrimaryKey(videoUserId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VideoUserEntry getVideoUserEntry(long videoUserId)
		throws PortalException, SystemException {
		return videoUserEntryPersistence.findByPrimaryKey(videoUserId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return videoUserEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<VideoUserEntry> getVideoUserEntries(int start, int end)
		throws SystemException {
		return videoUserEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getVideoUserEntriesCount() throws SystemException {
		return videoUserEntryPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VideoUserEntry updateVideoUserEntry(VideoUserEntry videoUserEntry)
		throws SystemException {
		return updateVideoUserEntry(videoUserEntry, true);
	}
	...
	public VideoUserEntry updateVideoUserEntry(VideoUserEntry videoUserEntry,
		...
		videoUserEntry = videoUserEntryPersistence.update(videoUserEntry, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.VideoUserEntry",
			videoUserEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.VideoUserEntry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = videoUserEntryPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(VideoUserEntryLocalServiceBaseImpl.class);
