...
/**
 * The base implementation of the video user transaction entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.VideoUserTransactionEntryLocalServiceImpl}.
 * </p>
 *
 * @author loind
 ...
 * @generated
 */
public abstract class VideoUserTransactionEntryLocalServiceBaseImpl
	implements VideoUserTransactionEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.VideoUserTransactionEntryLocalServiceUtil} to access the video user transaction entry local service.
	 */
	 ...
	 */
	public VideoUserTransactionEntry addVideoUserTransactionEntry(
		VideoUserTransactionEntry videoUserTransactionEntry)
		throws SystemException {
		videoUserTransactionEntry.setNew(true);

		videoUserTransactionEntry = videoUserTransactionEntryPersistence.update(videoUserTransactionEntry,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(videoUserTransactionEntry);
			}
	 ...
	 */
	public VideoUserTransactionEntry createVideoUserTransactionEntry(
		long transactionId) {
		return videoUserTransactionEntryPersistence.create(transactionId);
	}
	...
	public void deleteVideoUserTransactionEntry(long transactionId)
		...
		VideoUserTransactionEntry videoUserTransactionEntry = videoUserTransactionEntryPersistence.remove(transactionId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(videoUserTransactionEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteVideoUserTransactionEntry(
		VideoUserTransactionEntry videoUserTransactionEntry)
		throws SystemException {
		videoUserTransactionEntryPersistence.remove(videoUserTransactionEntry);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return videoUserTransactionEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return videoUserTransactionEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public VideoUserTransactionEntry fetchVideoUserTransactionEntry(
		long transactionId) throws SystemException {
		return videoUserTransactionEntryPersistence.fetchByPrimaryKey(transactionId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VideoUserTransactionEntry getVideoUserTransactionEntry(
		long transactionId) throws PortalException, SystemException {
		return videoUserTransactionEntryPersistence.findByPrimaryKey(transactionId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return videoUserTransactionEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<VideoUserTransactionEntry> getVideoUserTransactionEntries(
		int start, int end) throws SystemException {
		return videoUserTransactionEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getVideoUserTransactionEntriesCount() throws SystemException {
		return videoUserTransactionEntryPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VideoUserTransactionEntry updateVideoUserTransactionEntry(
		VideoUserTransactionEntry videoUserTransactionEntry)
		throws SystemException {
		return updateVideoUserTransactionEntry(videoUserTransactionEntry, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.VideoUserTransactionEntry",
			videoUserTransactionEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.VideoUserTransactionEntry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = videoUserTransactionEntryPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(VideoUserTransactionEntryLocalServiceBaseImpl.class);
