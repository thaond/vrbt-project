...
<c:if test="<%= isAllow %>">
	<br/>
	<%@ include file="/html/servicePackageTransactionChartReport/transaction_history_chart_form.jsp" %>
	<hr/>
	<br/>
	...
	<liferay-ui:search-container delta="10" emptyResultsMessage="portlet-service_transaction_history-view-search-container-emptyResultsMessage">
		<liferay-ui:search-container-results 
			results="<%= ServiceTransactionEntryLocalServiceUtil.searchServicePac(transactionCodeNumber, 0, 0, searchContainer.getStart(), searchContainer.getEnd(), 1) %>"
			total="<%= ServiceTransactionEntryLocalServiceUtil.searchServicePacCount(transactionCodeNumber, 0, 0, 1) %>"
		/>
