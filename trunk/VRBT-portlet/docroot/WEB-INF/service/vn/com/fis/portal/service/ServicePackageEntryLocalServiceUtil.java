...
/**
 * The utility for the service package entry local service. This utility wraps {@link vn.com.fis.portal.service.impl.ServicePackageEntryLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see vn.com.fis.portal.service.impl.ServicePackageEntryLocalServiceImpl
 * @generated
 */
public class ServicePackageEntryLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.com.fis.portal.service.impl.ServicePackageEntryLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static vn.com.fis.portal.model.ServicePackageEntry addServicePackageEntry(
		vn.com.fis.portal.model.ServicePackageEntry servicePackageEntry)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addServicePackageEntry(servicePackageEntry);
	}
	...
	*/
	public static vn.com.fis.portal.model.ServicePackageEntry createServicePackageEntry(
		long servicePackageId) {
		return getService().createServicePackageEntry(servicePackageId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteServicePackageEntry(long servicePackageId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().deleteServicePackageEntry(servicePackageId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteServicePackageEntry(
		vn.com.fis.portal.model.ServicePackageEntry servicePackageEntry)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().deleteServicePackageEntry(servicePackageEntry);
	}
	...
	*/
	...
	public static vn.com.fis.portal.model.ServicePackageEntry fetchServicePackageEntry(
		long servicePackageId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchServicePackageEntry(servicePackageId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.com.fis.portal.model.ServicePackageEntry getServicePackageEntry(
		long servicePackageId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getServicePackageEntry(servicePackageId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.com.fis.portal.model.ServicePackageEntry> getServicePackageEntries(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getServicePackageEntries(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getServicePackageEntriesCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getServicePackageEntriesCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.com.fis.portal.model.ServicePackageEntry updateServicePackageEntry(
		vn.com.fis.portal.model.ServicePackageEntry servicePackageEntry)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateServicePackageEntry(servicePackageEntry);
	}
	...
	*/
	public static vn.com.fis.portal.model.ServicePackageEntry updateServicePackageEntry(
		...
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateServicePackageEntry(servicePackageEntry, merge);
	}
	...
	*/
	...
	public static java.util.List<vn.com.fis.portal.model.ServicePackageEntry> findByserviceId_Status(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByserviceId_Status(serviceId, status);
	}
	...
	public static vn.com.fis.portal.model.ServicePackageEntry findByservicePackageCode(
		...
		return getService().findByservicePackageCode(servicePackageCode);
	}
	...
	public static ServicePackageEntryLocalService getService() {
		if (_service == null) {
			Object object = PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					ServicePackageEntryLocalService.class.getName());
			...
			_service = new ServicePackageEntryLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(ServicePackageEntryLocalServiceUtil.class,
				"_service");
			MethodCache.remove(ServicePackageEntryLocalService.class);
		}

		return _service;
	}

	public void setService(ServicePackageEntryLocalService service) {
		MethodCache.remove(ServicePackageEntryLocalService.class);
	...
	private static ServicePackageEntryLocalService _service;
}