...
/**
 * The utility for the video user contact entry local service. This utility wraps {@link vn.com.fis.portal.service.impl.VideoUserContactEntryLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see vn.com.fis.portal.service.impl.VideoUserContactEntryLocalServiceImpl
 * @generated
 */
public class VideoUserContactEntryLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.com.fis.portal.service.impl.VideoUserContactEntryLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static vn.com.fis.portal.model.VideoUserContactEntry addVideoUserContactEntry(
		vn.com.fis.portal.model.VideoUserContactEntry videoUserContactEntry)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addVideoUserContactEntry(videoUserContactEntry);
	}
	...
	*/
	public static vn.com.fis.portal.model.VideoUserContactEntry createVideoUserContactEntry(
		long videoUserContactId) {
		return getService().createVideoUserContactEntry(videoUserContactId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteVideoUserContactEntry(long videoUserContactId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().deleteVideoUserContactEntry(videoUserContactId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteVideoUserContactEntry(
		vn.com.fis.portal.model.VideoUserContactEntry videoUserContactEntry)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().deleteVideoUserContactEntry(videoUserContactEntry);
	}
	...
	*/
	...
	public static vn.com.fis.portal.model.VideoUserContactEntry fetchVideoUserContactEntry(
		long videoUserContactId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchVideoUserContactEntry(videoUserContactId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.com.fis.portal.model.VideoUserContactEntry getVideoUserContactEntry(
		long videoUserContactId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getVideoUserContactEntry(videoUserContactId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.com.fis.portal.model.VideoUserContactEntry> getVideoUserContactEntries(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getVideoUserContactEntries(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getVideoUserContactEntriesCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getVideoUserContactEntriesCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.com.fis.portal.model.VideoUserContactEntry updateVideoUserContactEntry(
		vn.com.fis.portal.model.VideoUserContactEntry videoUserContactEntry)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateVideoUserContactEntry(videoUserContactEntry);
	}
	...
	*/
	public static vn.com.fis.portal.model.VideoUserContactEntry updateVideoUserContactEntry(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .updateVideoUserContactEntry(videoUserContactEntry, merge);
	}
	...
	*/
	public static java.util.List<vn.com.fis.portal.model.VideoUserContactEntry> findByContactId_VideoUserId(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByContactId_VideoUserId(contactId, videoUserId);
	}
	...
	*/
	public static int countByContactId_VideoUserId(long contactId,
		long videoUserId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().countByContactId_VideoUserId(contactId, videoUserId);
	}
	...
	*/
	public static void removeByContactId_VideoUserId(long contactId,
		long videoUserId)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().removeByContactId_VideoUserId(contactId, videoUserId);
	}
	...
	public static VideoUserContactEntryLocalService getService() {
		if (_service == null) {
			Object object = PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					VideoUserContactEntryLocalService.class.getName());
			...
			_service = new VideoUserContactEntryLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(VideoUserContactEntryLocalServiceUtil.class,
				"_service");
			MethodCache.remove(VideoUserContactEntryLocalService.class);
		}

		return _service;
	}

	public void setService(VideoUserContactEntryLocalService service) {
		MethodCache.remove(VideoUserContactEntryLocalService.class);
	...
	private static VideoUserContactEntryLocalService _service;
}