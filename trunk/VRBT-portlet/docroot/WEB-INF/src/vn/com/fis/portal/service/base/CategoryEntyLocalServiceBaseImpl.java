...
/**
 * The base implementation of the category enty local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.CategoryEntyLocalServiceImpl}.
 * </p>
 *
 * @author loind
 ...
 * @generated
 */
public abstract class CategoryEntyLocalServiceBaseImpl
	implements CategoryEntyLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.CategoryEntyLocalServiceUtil} to access the category enty local service.
	 */
	 ...
	 */
	public CategoryEnty addCategoryEnty(CategoryEnty categoryEnty)
		throws SystemException {
		categoryEnty.setNew(true);

		categoryEnty = categoryEntyPersistence.update(categoryEnty, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(categoryEnty);
			}
	 ...
	 */
	public CategoryEnty createCategoryEnty(long categoryId) {
		return categoryEntyPersistence.create(categoryId);
	}
	...
	public void deleteCategoryEnty(long categoryId)
		...
		CategoryEnty categoryEnty = categoryEntyPersistence.remove(categoryId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(categoryEnty);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteCategoryEnty(CategoryEnty categoryEnty)
		throws SystemException {
		categoryEntyPersistence.remove(categoryEnty);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return categoryEntyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return categoryEntyPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public CategoryEnty fetchCategoryEnty(long categoryId)
		throws SystemException {
		return categoryEntyPersistence.fetchByPrimaryKey(categoryId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CategoryEnty getCategoryEnty(long categoryId)
		throws PortalException, SystemException {
		return categoryEntyPersistence.findByPrimaryKey(categoryId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return categoryEntyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<CategoryEnty> getCategoryEnties(int start, int end)
		throws SystemException {
		return categoryEntyPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCategoryEntiesCount() throws SystemException {
		return categoryEntyPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CategoryEnty updateCategoryEnty(CategoryEnty categoryEnty)
		throws SystemException {
		return updateCategoryEnty(categoryEnty, true);
	}
	...
	public CategoryEnty updateCategoryEnty(CategoryEnty categoryEnty,
		...
		categoryEnty = categoryEntyPersistence.update(categoryEnty, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.CategoryEnty",
			categoryEntyLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.CategoryEnty");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = categoryEntyPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(CategoryEntyLocalServiceBaseImpl.class);
