...
/**
 * The base implementation of the contact group contact entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.ContactGroupContactEntryLocalServiceImpl}.
 * </p>
 *
 * @author loind
 ...
 * @generated
 */
public abstract class ContactGroupContactEntryLocalServiceBaseImpl
	implements ContactGroupContactEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.ContactGroupContactEntryLocalServiceUtil} to access the contact group contact entry local service.
	 */
	 ...
	 */
	public ContactGroupContactEntry addContactGroupContactEntry(
		ContactGroupContactEntry contactGroupContactEntry)
		throws SystemException {
		contactGroupContactEntry.setNew(true);

		contactGroupContactEntry = contactGroupContactEntryPersistence.update(contactGroupContactEntry,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(contactGroupContactEntry);
			}
	 ...
	 */
	public ContactGroupContactEntry createContactGroupContactEntry(
		long contactGroupContactId) {
		return contactGroupContactEntryPersistence.create(contactGroupContactId);
	}
	...
	public void deleteContactGroupContactEntry(long contactGroupContactId)
		...
		ContactGroupContactEntry contactGroupContactEntry = contactGroupContactEntryPersistence.remove(contactGroupContactId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(contactGroupContactEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteContactGroupContactEntry(
		ContactGroupContactEntry contactGroupContactEntry)
		throws SystemException {
		contactGroupContactEntryPersistence.remove(contactGroupContactEntry);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return contactGroupContactEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return contactGroupContactEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ContactGroupContactEntry fetchContactGroupContactEntry(
		long contactGroupContactId) throws SystemException {
		return contactGroupContactEntryPersistence.fetchByPrimaryKey(contactGroupContactId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ContactGroupContactEntry getContactGroupContactEntry(
		long contactGroupContactId) throws PortalException, SystemException {
		return contactGroupContactEntryPersistence.findByPrimaryKey(contactGroupContactId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return contactGroupContactEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ContactGroupContactEntry> getContactGroupContactEntries(
		int start, int end) throws SystemException {
		return contactGroupContactEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getContactGroupContactEntriesCount() throws SystemException {
		return contactGroupContactEntryPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ContactGroupContactEntry updateContactGroupContactEntry(
		ContactGroupContactEntry contactGroupContactEntry)
		throws SystemException {
		return updateContactGroupContactEntry(contactGroupContactEntry, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.ContactGroupContactEntry",
			contactGroupContactEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.ContactGroupContactEntry");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(ContactGroupContactEntryLocalServiceBaseImpl.class);
