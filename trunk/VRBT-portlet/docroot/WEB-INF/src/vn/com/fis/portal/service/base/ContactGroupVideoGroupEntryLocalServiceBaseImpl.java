...
/**
 * The base implementation of the contact group video group entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.ContactGroupVideoGroupEntryLocalServiceImpl}.
 * </p>
 *
 * @author loind
 ...
 * @generated
 */
public abstract class ContactGroupVideoGroupEntryLocalServiceBaseImpl
	implements ContactGroupVideoGroupEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.ContactGroupVideoGroupEntryLocalServiceUtil} to access the contact group video group entry local service.
	 */
	 ...
	 */
	public ContactGroupVideoGroupEntry addContactGroupVideoGroupEntry(
		ContactGroupVideoGroupEntry contactGroupVideoGroupEntry)
		throws SystemException {
		contactGroupVideoGroupEntry.setNew(true);

		contactGroupVideoGroupEntry = contactGroupVideoGroupEntryPersistence.update(contactGroupVideoGroupEntry,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(contactGroupVideoGroupEntry);
			}
	 ...
	 */
	public ContactGroupVideoGroupEntry createContactGroupVideoGroupEntry(
		long contactGroupVideoGroupEntryId) {
		return contactGroupVideoGroupEntryPersistence.create(contactGroupVideoGroupEntryId);
	}
	...
	public void deleteContactGroupVideoGroupEntry(
		...
		ContactGroupVideoGroupEntry contactGroupVideoGroupEntry = contactGroupVideoGroupEntryPersistence.remove(contactGroupVideoGroupEntryId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(contactGroupVideoGroupEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteContactGroupVideoGroupEntry(
		ContactGroupVideoGroupEntry contactGroupVideoGroupEntry)
		throws SystemException {
		contactGroupVideoGroupEntryPersistence.remove(contactGroupVideoGroupEntry);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return contactGroupVideoGroupEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return contactGroupVideoGroupEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ContactGroupVideoGroupEntry fetchContactGroupVideoGroupEntry(
		long contactGroupVideoGroupEntryId) throws SystemException {
		return contactGroupVideoGroupEntryPersistence.fetchByPrimaryKey(contactGroupVideoGroupEntryId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ContactGroupVideoGroupEntry getContactGroupVideoGroupEntry(
		long contactGroupVideoGroupEntryId)
		throws PortalException, SystemException {
		return contactGroupVideoGroupEntryPersistence.findByPrimaryKey(contactGroupVideoGroupEntryId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return contactGroupVideoGroupEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ContactGroupVideoGroupEntry> getContactGroupVideoGroupEntries(
		int start, int end) throws SystemException {
		return contactGroupVideoGroupEntryPersistence.findAll(start, end);
	}
	...
	public int getContactGroupVideoGroupEntriesCount()
		throws SystemException {
		return contactGroupVideoGroupEntryPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ContactGroupVideoGroupEntry updateContactGroupVideoGroupEntry(
		ContactGroupVideoGroupEntry contactGroupVideoGroupEntry)
		throws SystemException {
		return updateContactGroupVideoGroupEntry(contactGroupVideoGroupEntry,
			true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.ContactGroupVideoGroupEntry",
			contactGroupVideoGroupEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.ContactGroupVideoGroupEntry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = contactGroupVideoGroupEntryPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(ContactGroupVideoGroupEntryLocalServiceBaseImpl.class);
