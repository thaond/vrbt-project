...
/**
 * The base implementation of the folder entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.FolderEntryLocalServiceImpl}.
 * </p>
 *
 * @author loind
 ...
 * @generated
 */
public abstract class FolderEntryLocalServiceBaseImpl
	implements FolderEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.FolderEntryLocalServiceUtil} to access the folder entry local service.
	 */
	...
	public FolderEntry addFolderEntry(FolderEntry folderEntry)
		...
		folderEntry = folderEntryPersistence.update(folderEntry, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(folderEntry);
			}
	 ...
	 */
	public FolderEntry createFolderEntry(long folderId) {
		return folderEntryPersistence.create(folderId);
	}
	...
	public void deleteFolderEntry(long folderId)
		...
		FolderEntry folderEntry = folderEntryPersistence.remove(folderId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(folderEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteFolderEntry(FolderEntry folderEntry)
		throws SystemException {
		folderEntryPersistence.remove(folderEntry);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return folderEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return folderEntryPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return folderEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public FolderEntry fetchFolderEntry(long folderId)
		throws SystemException {
		return folderEntryPersistence.fetchByPrimaryKey(folderId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public FolderEntry getFolderEntry(long folderId)
		throws PortalException, SystemException {
		return folderEntryPersistence.findByPrimaryKey(folderId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return folderEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<FolderEntry> getFolderEntries(int start, int end)
		throws SystemException {
		return folderEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getFolderEntriesCount() throws SystemException {
		return folderEntryPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public FolderEntry updateFolderEntry(FolderEntry folderEntry)
		throws SystemException {
		return updateFolderEntry(folderEntry, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public FolderEntry updateFolderEntry(FolderEntry folderEntry, boolean merge)
		throws SystemException {
		folderEntry.setNew(false);

		folderEntry = folderEntryPersistence.update(folderEntry, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.FolderEntry",
			folderEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.FolderEntry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = folderEntryPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(FolderEntryLocalServiceBaseImpl.class);
