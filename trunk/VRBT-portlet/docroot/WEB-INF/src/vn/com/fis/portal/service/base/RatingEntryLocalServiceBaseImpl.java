...
/**
 * The base implementation of the rating entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.RatingEntryLocalServiceImpl}.
 * </p>
 *
 * @author loind
 ...
 * @generated
 */
public abstract class RatingEntryLocalServiceBaseImpl
	implements RatingEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.RatingEntryLocalServiceUtil} to access the rating entry local service.
	 */
	 ...
	 */
	public RatingEntry addRatingEntry(RatingEntry ratingEntry)
		throws SystemException {
		ratingEntry.setNew(true);

		ratingEntry = ratingEntryPersistence.update(ratingEntry, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(ratingEntry);
			}
	 ...
	 */
	public RatingEntry createRatingEntry(long ratingId) {
		return ratingEntryPersistence.create(ratingId);
	}
	...
	public void deleteRatingEntry(long ratingId)
		...
		RatingEntry ratingEntry = ratingEntryPersistence.remove(ratingId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(ratingEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteRatingEntry(RatingEntry ratingEntry)
		throws SystemException {
		ratingEntryPersistence.remove(ratingEntry);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return ratingEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return ratingEntryPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return ratingEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public RatingEntry fetchRatingEntry(long ratingId)
		throws SystemException {
		return ratingEntryPersistence.fetchByPrimaryKey(ratingId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public RatingEntry getRatingEntry(long ratingId)
		throws PortalException, SystemException {
		return ratingEntryPersistence.findByPrimaryKey(ratingId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return ratingEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<RatingEntry> getRatingEntries(int start, int end)
		throws SystemException {
		return ratingEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getRatingEntriesCount() throws SystemException {
		return ratingEntryPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public RatingEntry updateRatingEntry(RatingEntry ratingEntry)
		throws SystemException {
		return updateRatingEntry(ratingEntry, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public RatingEntry updateRatingEntry(RatingEntry ratingEntry, boolean merge)
		throws SystemException {
		ratingEntry.setNew(false);

		ratingEntry = ratingEntryPersistence.update(ratingEntry, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.RatingEntry",
			ratingEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.RatingEntry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = ratingEntryPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(RatingEntryLocalServiceBaseImpl.class);
