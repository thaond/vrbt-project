...
/**
 * The base implementation of the service package entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.ServicePackageEntryLocalServiceImpl}.
 * </p>
 *
 * @author loind
 ...
 * @generated
 */
public abstract class ServicePackageEntryLocalServiceBaseImpl
	implements ServicePackageEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.ServicePackageEntryLocalServiceUtil} to access the service package entry local service.
	 */
	 ...
	 */
	public ServicePackageEntry addServicePackageEntry(
		ServicePackageEntry servicePackageEntry) throws SystemException {
		servicePackageEntry.setNew(true);

		servicePackageEntry = servicePackageEntryPersistence.update(servicePackageEntry,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(servicePackageEntry);
			}
	 ...
	 */
	public ServicePackageEntry createServicePackageEntry(long servicePackageId) {
		return servicePackageEntryPersistence.create(servicePackageId);
	}
	...
	public void deleteServicePackageEntry(long servicePackageId)
		...
		ServicePackageEntry servicePackageEntry = servicePackageEntryPersistence.remove(servicePackageId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(servicePackageEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteServicePackageEntry(
		ServicePackageEntry servicePackageEntry) throws SystemException {
		servicePackageEntryPersistence.remove(servicePackageEntry);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return servicePackageEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return servicePackageEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ServicePackageEntry fetchServicePackageEntry(long servicePackageId)
		throws SystemException {
		return servicePackageEntryPersistence.fetchByPrimaryKey(servicePackageId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ServicePackageEntry getServicePackageEntry(long servicePackageId)
		throws PortalException, SystemException {
		return servicePackageEntryPersistence.findByPrimaryKey(servicePackageId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return servicePackageEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ServicePackageEntry> getServicePackageEntries(int start, int end)
		throws SystemException {
		return servicePackageEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getServicePackageEntriesCount() throws SystemException {
		return servicePackageEntryPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ServicePackageEntry updateServicePackageEntry(
		ServicePackageEntry servicePackageEntry) throws SystemException {
		return updateServicePackageEntry(servicePackageEntry, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.ServicePackageEntry",
			servicePackageEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.ServicePackageEntry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = servicePackageEntryPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(ServicePackageEntryLocalServiceBaseImpl.class);
