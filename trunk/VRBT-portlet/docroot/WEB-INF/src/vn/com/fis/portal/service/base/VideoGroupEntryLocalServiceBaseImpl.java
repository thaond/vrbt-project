...
/**
 * The base implementation of the video group entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.VideoGroupEntryLocalServiceImpl}.
 * </p>
 *
 * @author loind
 ...
 * @generated
 */
public abstract class VideoGroupEntryLocalServiceBaseImpl
	implements VideoGroupEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.VideoGroupEntryLocalServiceUtil} to access the video group entry local service.
	 */
	 ...
	 */
	public VideoGroupEntry addVideoGroupEntry(VideoGroupEntry videoGroupEntry)
		throws SystemException {
		videoGroupEntry.setNew(true);

		videoGroupEntry = videoGroupEntryPersistence.update(videoGroupEntry,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(videoGroupEntry);
			}
	 ...
	 */
	public VideoGroupEntry createVideoGroupEntry(long videoGroupId) {
		return videoGroupEntryPersistence.create(videoGroupId);
	}
	...
	public void deleteVideoGroupEntry(long videoGroupId)
		...
		VideoGroupEntry videoGroupEntry = videoGroupEntryPersistence.remove(videoGroupId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(videoGroupEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVideoGroupEntry(VideoGroupEntry videoGroupEntry)
		throws SystemException {
		videoGroupEntryPersistence.remove(videoGroupEntry);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return videoGroupEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return videoGroupEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public VideoGroupEntry fetchVideoGroupEntry(long videoGroupId)
		throws SystemException {
		return videoGroupEntryPersistence.fetchByPrimaryKey(videoGroupId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VideoGroupEntry getVideoGroupEntry(long videoGroupId)
		throws PortalException, SystemException {
		return videoGroupEntryPersistence.findByPrimaryKey(videoGroupId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return videoGroupEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<VideoGroupEntry> getVideoGroupEntries(int start, int end)
		throws SystemException {
		return videoGroupEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getVideoGroupEntriesCount() throws SystemException {
		return videoGroupEntryPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VideoGroupEntry updateVideoGroupEntry(
		VideoGroupEntry videoGroupEntry) throws SystemException {
		return updateVideoGroupEntry(videoGroupEntry, true);
	}
	 ...
	 */
	public VideoGroupEntry updateVideoGroupEntry(
		VideoGroupEntry videoGroupEntry, boolean merge)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.VideoGroupEntry",
			videoGroupEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.VideoGroupEntry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = videoGroupEntryPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(VideoGroupEntryLocalServiceBaseImpl.class);
