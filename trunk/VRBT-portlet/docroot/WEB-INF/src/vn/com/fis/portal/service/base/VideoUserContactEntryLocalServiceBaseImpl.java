...
/**
 * The base implementation of the video user contact entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.VideoUserContactEntryLocalServiceImpl}.
 * </p>
 *
 * @author loind
 ...
 * @generated
 */
public abstract class VideoUserContactEntryLocalServiceBaseImpl
	implements VideoUserContactEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.VideoUserContactEntryLocalServiceUtil} to access the video user contact entry local service.
	 */
	 ...
	 */
	public VideoUserContactEntry addVideoUserContactEntry(
		VideoUserContactEntry videoUserContactEntry) throws SystemException {
		videoUserContactEntry.setNew(true);

		videoUserContactEntry = videoUserContactEntryPersistence.update(videoUserContactEntry,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(videoUserContactEntry);
			}
	 ...
	 */
	public VideoUserContactEntry createVideoUserContactEntry(
		long videoUserContactId) {
		return videoUserContactEntryPersistence.create(videoUserContactId);
	}
	...
	public void deleteVideoUserContactEntry(long videoUserContactId)
		...
		VideoUserContactEntry videoUserContactEntry = videoUserContactEntryPersistence.remove(videoUserContactId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(videoUserContactEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteVideoUserContactEntry(
		VideoUserContactEntry videoUserContactEntry) throws SystemException {
		videoUserContactEntryPersistence.remove(videoUserContactEntry);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return videoUserContactEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return videoUserContactEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public VideoUserContactEntry fetchVideoUserContactEntry(
		long videoUserContactId) throws SystemException {
		return videoUserContactEntryPersistence.fetchByPrimaryKey(videoUserContactId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VideoUserContactEntry getVideoUserContactEntry(
		long videoUserContactId) throws PortalException, SystemException {
		return videoUserContactEntryPersistence.findByPrimaryKey(videoUserContactId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return videoUserContactEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<VideoUserContactEntry> getVideoUserContactEntries(int start,
		int end) throws SystemException {
		return videoUserContactEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getVideoUserContactEntriesCount() throws SystemException {
		return videoUserContactEntryPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VideoUserContactEntry updateVideoUserContactEntry(
		VideoUserContactEntry videoUserContactEntry) throws SystemException {
		return updateVideoUserContactEntry(videoUserContactEntry, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.VideoUserContactEntry",
			videoUserContactEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.VideoUserContactEntry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = videoUserContactEntryPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(VideoUserContactEntryLocalServiceBaseImpl.class);
