...
/**
 * The base implementation of the video user video group entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.VideoUserVideoGroupEntryLocalServiceImpl}.
 * </p>
 *
 * @author loind
 * @see vn.com.fis.portal.service.impl.VideoUserVideoGroupEntryLocalServiceImpl
 * @see vn.com.fis.portal.service.VideoUserVideoGroupEntryLocalServiceUtil
 * @generated
 */
public abstract class VideoUserVideoGroupEntryLocalServiceBaseImpl
	implements VideoUserVideoGroupEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.VideoUserVideoGroupEntryLocalServiceUtil} to access the video user video group entry local service.
	 */

	/**
	 * Adds the video user video group entry to the database. Also notifies the appropriate model listeners.
	 *
	 * @param videoUserVideoGroupEntry the video user video group entry
	 * @return the video user video group entry that was added
	 * @throws SystemException if a system exception occurred
	 */
	public VideoUserVideoGroupEntry addVideoUserVideoGroupEntry(
		VideoUserVideoGroupEntry videoUserVideoGroupEntry)
		throws SystemException {
		videoUserVideoGroupEntry.setNew(true);

		videoUserVideoGroupEntry = videoUserVideoGroupEntryPersistence.update(videoUserVideoGroupEntry,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(videoUserVideoGroupEntry);
			}
	 ...
	 */
	public VideoUserVideoGroupEntry createVideoUserVideoGroupEntry(
		long videoUserVideoGroupID) {
		return videoUserVideoGroupEntryPersistence.create(videoUserVideoGroupID);
	}

	/**
	 * Deletes the video user video group entry with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param videoUserVideoGroupID the primary key of the video user video group entry
	 * @throws PortalException if a video user video group entry with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVideoUserVideoGroupEntry(long videoUserVideoGroupID)
		throws PortalException, SystemException {
		VideoUserVideoGroupEntry videoUserVideoGroupEntry = videoUserVideoGroupEntryPersistence.remove(videoUserVideoGroupID);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(videoUserVideoGroupEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	/**
	 * Deletes the video user video group entry from the database. Also notifies the appropriate model listeners.
	 *
	 * @param videoUserVideoGroupEntry the video user video group entry
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteVideoUserVideoGroupEntry(
		VideoUserVideoGroupEntry videoUserVideoGroupEntry)
		throws SystemException {
		videoUserVideoGroupEntryPersistence.remove(videoUserVideoGroupEntry);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return videoUserVideoGroupEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return videoUserVideoGroupEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public VideoUserVideoGroupEntry fetchVideoUserVideoGroupEntry(
		long videoUserVideoGroupID) throws SystemException {
		return videoUserVideoGroupEntryPersistence.fetchByPrimaryKey(videoUserVideoGroupID);
	}

	/**
	 * Returns the video user video group entry with the primary key.
	 *
	 * @param videoUserVideoGroupID the primary key of the video user video group entry
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public VideoUserVideoGroupEntry getVideoUserVideoGroupEntry(
		long videoUserVideoGroupID) throws PortalException, SystemException {
		return videoUserVideoGroupEntryPersistence.findByPrimaryKey(videoUserVideoGroupID);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return videoUserVideoGroupEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<VideoUserVideoGroupEntry> getVideoUserVideoGroupEntries(
		int start, int end) throws SystemException {
		return videoUserVideoGroupEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getVideoUserVideoGroupEntriesCount() throws SystemException {
		return videoUserVideoGroupEntryPersistence.countAll();
	}

	/**
	 * Updates the video user video group entry in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param videoUserVideoGroupEntry the video user video group entry
	 * @return the video user video group entry that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public VideoUserVideoGroupEntry updateVideoUserVideoGroupEntry(
		VideoUserVideoGroupEntry videoUserVideoGroupEntry)
		throws SystemException {
		return updateVideoUserVideoGroupEntry(videoUserVideoGroupEntry, true);
	}
	 ...
	 *
	 * @param videoUserVideoGroupEntry the video user video group entry
	 * @param merge whether to merge the video user video group entry with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the video user video group entry that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public VideoUserVideoGroupEntry updateVideoUserVideoGroupEntry(
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.VideoUserVideoGroupEntry",
			videoUserVideoGroupEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.VideoUserVideoGroupEntry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = videoUserVideoGroupEntryPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(VideoUserVideoGroupEntryLocalServiceBaseImpl.class);
