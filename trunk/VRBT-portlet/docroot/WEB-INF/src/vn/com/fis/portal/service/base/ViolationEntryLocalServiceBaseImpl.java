...
/**
 * The base implementation of the violation entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.ViolationEntryLocalServiceImpl}.
 * </p>
 *
 * @author loind
 ...
 * @generated
 */
public abstract class ViolationEntryLocalServiceBaseImpl
	implements ViolationEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.ViolationEntryLocalServiceUtil} to access the violation entry local service.
	 */
	 ...
	 */
	public ViolationEntry addViolationEntry(ViolationEntry violationEntry)
		throws SystemException {
		violationEntry.setNew(true);

		violationEntry = violationEntryPersistence.update(violationEntry, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(violationEntry);
			}
	 ...
	 */
	public ViolationEntry createViolationEntry(long violationId) {
		return violationEntryPersistence.create(violationId);
	}
	...
	public void deleteViolationEntry(long violationId)
		...
		ViolationEntry violationEntry = violationEntryPersistence.remove(violationId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(violationEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteViolationEntry(ViolationEntry violationEntry)
		throws SystemException {
		violationEntryPersistence.remove(violationEntry);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return violationEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return violationEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ViolationEntry fetchViolationEntry(long violationId)
		throws SystemException {
		return violationEntryPersistence.fetchByPrimaryKey(violationId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ViolationEntry getViolationEntry(long violationId)
		throws PortalException, SystemException {
		return violationEntryPersistence.findByPrimaryKey(violationId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return violationEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ViolationEntry> getViolationEntries(int start, int end)
		throws SystemException {
		return violationEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getViolationEntriesCount() throws SystemException {
		return violationEntryPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ViolationEntry updateViolationEntry(ViolationEntry violationEntry)
		throws SystemException {
		return updateViolationEntry(violationEntry, true);
	}
	...
	public ViolationEntry updateViolationEntry(ViolationEntry violationEntry,
		...
		violationEntry = violationEntryPersistence.update(violationEntry, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.ViolationEntry",
			violationEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.ViolationEntry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = violationEntryPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(ViolationEntryLocalServiceBaseImpl.class);
