...
/**
 * The base implementation of the violation video entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.fis.portal.service.impl.ViolationVideoEntryLocalServiceImpl}.
 * </p>
 *
 * @author loind
 ...
 * @generated
 */
public abstract class ViolationVideoEntryLocalServiceBaseImpl
	implements ViolationVideoEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.fis.portal.service.ViolationVideoEntryLocalServiceUtil} to access the violation video entry local service.
	 */
	 ...
	 */
	public ViolationVideoEntry addViolationVideoEntry(
		ViolationVideoEntry violationVideoEntry) throws SystemException {
		violationVideoEntry.setNew(true);

		violationVideoEntry = violationVideoEntryPersistence.update(violationVideoEntry,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(violationVideoEntry);
			}
	 ...
	 */
	public ViolationVideoEntry createViolationVideoEntry(long violationVideoId) {
		return violationVideoEntryPersistence.create(violationVideoId);
	}
	...
	public void deleteViolationVideoEntry(long violationVideoId)
		...
		ViolationVideoEntry violationVideoEntry = violationVideoEntryPersistence.remove(violationVideoId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(violationVideoEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteViolationVideoEntry(
		ViolationVideoEntry violationVideoEntry) throws SystemException {
		violationVideoEntryPersistence.remove(violationVideoEntry);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return violationVideoEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return violationVideoEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ViolationVideoEntry fetchViolationVideoEntry(long violationVideoId)
		throws SystemException {
		return violationVideoEntryPersistence.fetchByPrimaryKey(violationVideoId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ViolationVideoEntry getViolationVideoEntry(long violationVideoId)
		throws PortalException, SystemException {
		return violationVideoEntryPersistence.findByPrimaryKey(violationVideoId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return violationVideoEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ViolationVideoEntry> getViolationVideoEntries(int start, int end)
		throws SystemException {
		return violationVideoEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getViolationVideoEntriesCount() throws SystemException {
		return violationVideoEntryPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ViolationVideoEntry updateViolationVideoEntry(
		ViolationVideoEntry violationVideoEntry) throws SystemException {
		return updateViolationVideoEntry(violationVideoEntry, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.com.fis.portal.model.ViolationVideoEntry",
			violationVideoEntryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.com.fis.portal.model.ViolationVideoEntry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = violationVideoEntryPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(ViolationVideoEntryLocalServiceBaseImpl.class);
