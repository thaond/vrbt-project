...
public class ServiceEntryFinderImpl extends BasePersistenceImpl implements ServiceEntryFinder {
	private final String SEARCH_SQL_ID = ServiceEntryFinderImpl.class.getName()+".search";
	private final String SEARCH_COUNT_SQL_ID = ServiceEntryFinderImpl.class.getName()+".searchCount";

	private final String START_SERVICE_CODE = "001";
	private final String UPLOAD_SERVICE_PACKAGE = "002";
	...
	public boolean isStartService(String serviceCode) {
		return serviceCode.equals(START_SERVICE_CODE);
	}
