...
<fieldset>
	<aui:form name="searchTransactionHistoryForm" method="post" action="<%= searchTransactionHistoryURL %>">
		<aui:select name="serviceTransactionCode" label="portlet-service_transaction_history-transaction_history_search_form-select-serviceTransactionCode">
			...
			<aui:option label="portlet-service_transaction_history-transaction_history_search_form-select-option-type-4" 
				value="4" selected="<%= transactionCodeNumber == 4 %>"/>
			<aui:option label="portlet-service_transaction_history-transaction_history_search_form-select-option-type-5" 
				value="5" selected="<%= transactionCodeNumber == 5 %>"/>
		</aui:select>
