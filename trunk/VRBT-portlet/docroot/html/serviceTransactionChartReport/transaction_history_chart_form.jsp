	...
	<fieldset>
		<div>
			...
			<ul>
				...
				<c:if test="<%= viewService != null %>">
					<!-- <span id="usingService_Chart" ><%= UserServiceEntryLocalServiceUtil.countByserviceId_Status(viewService.getServiceId(), 1) %>
						#<%= UserEntryLocalServiceUtil.countByStatus(1) -  UserServiceEntryLocalServiceUtil.countByserviceId_Status(viewService.getServiceId(), 1) %>
					</span>
					...
					<span id="spanDataPieChart" >In Use#<%= UserServiceEntryLocalServiceUtil.countByserviceId_Status(viewService.getServiceId(), 1) %>
						@Not Use#<%= UserEntryLocalServiceUtil.countByStatus(1) -  UserServiceEntryLocalServiceUtil.countByserviceId_Status(viewService.getServiceId(), 1) %>
					</span>
